...
ROSTERS_URL = "https://github.com/llevasseur/"+NAME+"/blob/main/alpha/ROSTERS.md"
STANDINGS_URL = "https://github.com/llevasseur/"+NAME+"/blob/main/alpha/STANDINGS.md"
...
def main():
    ...
    STANDINGS_md = open(cwd + '/alpha/STANDINGS.md', 'w')
    ...
    README_md = open(cwd + '/alpha/README.md', 'w')
    ...
    print('''
    Participant standings parsed!! They have been written to /alpha/README.md, /alpha/STANDINGS.md, and /alpha/ROSTERS.md.
