...
def main():
    ...
    README_md.write(f"| User | [G]({STANDINGS_URL}javascript:;user-content-goals) | [A]({STANDINGS_URL}javascript:;user-content-assists) | [SOG]({STANDINGS_URL}javascript:;user-content-shots-on-goal) | [PIM]({STANDINGS_URL}javascript:;user-content-penalties-in-minutes) | [+/-]({STANDINGS_URL}javascript:;user-content-plus--minus) | [TPM]({STANDINGS_URL}javascript:;user-content-time-played-in-minutes) | [S%]({STANDINGS_URL}javascript:;user-content-save-percentage) | [GAA]({STANDINGS_URL}javascript:;user-content-goals-against-average) | Total |\n")
    README_md.write(
        f"| :--- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |  -----: |\n")
    ...
    for user in overall_points:
        README_md.write(f"| [{user}]({ROSTERS_URL}javascript:;user-content-{user}) | ")
